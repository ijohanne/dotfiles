...

{
  services.dhcpd4 = {
    ...
    extraConfig = ''
      ...
      host camera-kitchen {
        hardware ethernet 5c:c3:36:39:7f:c9;
        fixed-address 10.255.100.222;
      }
      ...
      host fatty-ipmi {
        hardware ethernet 04:42:1A:1C:6C:C1;
        fixed-address 10.255.254.211;
      }

      host pakhat {
        hardware ethernet 58:9c:fc:0e:56:98;
        fixed-address 10.255.101.200;
      }
    '';
  };
